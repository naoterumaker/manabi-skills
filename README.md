...
npx skills add naoteru/manabi-skills -g -a claude-code -y --copy
```
...
# 特定スキルだけ入れる場合
npx skills add naoteru/manabi-skills -g -a claude-code --skill manabi-ingest -y --copy
```
...
# Codex向け
npx skills add naoteru/manabi-skills -g -a codex -y --copy

# 両方向け
npx skills add naoteru/manabi-skills -g -a claude-code -a codex -y --copy

# スキル一覧表示
npx skills add naoteru/manabi-skills --list
